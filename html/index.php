...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../assets/img/bg_image_1.jpg)">
    ...
    <div class="navbar navbar-expand-lg navbar-dark sticky" data-offset="500">
      <div class="container">
        <a href="" class="navbar-brand">Franck Seka</a>
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">Franck</b> Seka</h1>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="../assets/img/_DSC6844.JPG" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Franck Seka</h1>
          <h5 class="fg-theme mb-3">Web Developer</h5>
          <p class="text-muted">Full Stack Developer ready to work.</p>
          <ul class="theme-list">
            <li><b>From:</b> Abidjan, CIV</li>
            <li><b>Lives In:</b> Paris, France</li>
          </ul>
          <a href="../assets/img/Franck G. SEKA.pdf"><button class="btn btn-theme-outline">Download CV</button></a>
        </div>
      </div>
    </div>
    <div class="container py-5">
    ...
    <div class="container pt-5">
      <div class="row">
        <div class="col-md-6 wow fadeInRight">
          <h2 class="fw-normal">Formation</h2>
          <ul class="timeline mt-4 pr-md-5">
            <li>
              <div class="title">2022 - 2024</div>
              <div class="details">
                <h5>Master</h5>
                <small class="fg-theme">EFREI Paris</small>
                <p>Dev Manager Full Stack</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>Bachelor</h5>
                <small class="fg-theme">École IRIS</small>
                <p>Bachelor - développement de solution digital</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>BTS</h5>
                <small class="fg-theme">École IRIS</small>
                <p>Brevet de technicien supérieur (BTS) logicielles et applications métiers</p>
              </div>
            </li>
          </ul>
        </div>
        <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
          <h2 class="fw-normal">Experiences Professionnelles</h2>
          <ul class="timeline mt-4 pr-md-5">
            <li>
            ...
            <li>
              ...
              <div class="details">
                <h5>Myphotoagency</h5>
                <small class="fg-theme">École IRIS</small>
                <p>- Intervention sur le back office de Drupal 9
                  - Integration du nouveau site vitrine de l'entreprise.
                  - Développement sur CMS Drupal 9 avec un coeur Symfony.
                  - Utilisation de GitLab, Docker et de Composer.</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>Stage IRIS</h5>
                <small class="fg-theme">École IRIS</small>
                <p>- Élaboration d'un site web, avec les méthodes POO et MVC.
                  - Mise en place d'un flux RSS dynamique en PHP, via des mots clefs.
                  - Création d'un site en PHP pour faciliter la tâche à un lycée dans
                   la gestion des retards des élèves qui prennent les transports en commun.</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>Cela fait parti de mon domaine d'expérience depuis un an, je reste cependant dans la quête de connaissance</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>Toujours à la recherche de savoir et de connaissance pour élargir mes acquis</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>Une partie de ma formation en Bachelor a été basé la-dessus, je continue de travailler pour toujours m'ameliorer</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
  ...
  <div class="vg-page page-funfact" style="background-image: url(../assets/img/IMG_6611.HEIC);">
    <div class="container">
  ...
  <div class="vg-page page-portfolio" id="portfolio">
    <div class="container">
      ...
      <div class="gridder my-3">
        ...
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="../assets/img/work/barber-shop.png" data-fancybox data-caption="<h5 class='fg-theme'>Barber Shop</h5> <p>Barber shop, Maquette</p>">
            <img src="../assets/img/work/barber-shop.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Barber Shop</h5>
              <p>Barber shop, Maquette</p>
            </div>
          </div>
        </div>
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="../assets/img/work/maquette_barber.png" data-fancybox data-caption="<h5 class='fg-theme'>Barber Shop</h5> <p>Barber shop, Maquette</p>">
            <img src="../assets/img/work/maquette_barber.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Barber Shop</h5>
              <p>Barber shop, Maquette</p>
            </div>
          ...
          <div class="owl-carousel testi-carousel">
            <div class="item">
              <div class="row">
                <div class="col-md-6">
                  <div class="img-place">
                    <img src="../assets/img/testimonials/virgine.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="caption">
                    ...
                    <div class="testi-info">
                      ...
                      <div class="tagline">
                        <h5 class="mb-0">Virginie HILDEBERT</h5>
                        <span class="text-muted">CEO Passion Afro Food</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6">
                  <div class="img-place">
                    <img src="../assets/img/testimonials/IMG_7768.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="caption">
  ...
  <div class="vg-page page-contact" id="contact">
    <div class="container-fluid">
      ...
      <div class="row py-5">
        ...
        <div class="col-lg-5">
          <form class="vg-contact-form" id="form" action="traitement.php" method="post">
            <div class="form-row">
              ...
              <button type="submit" class="btn btn-theme mt-3 wow fadeInUp ml-1" value="envoyer" name="send" >Send Message</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <!-- Footer -->
  <div class="vg-footer">
    <h1 class="text-center">Franck Seka</h1>
    <div class="container">
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="footer-info">
            ...
            <hr class="divider">
            <p class="fs-large fg-white">Île-de-France, France</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <ul class="list-unstyled">
              <li><a href="https://www.linkedin.com/in/franck-geoffroy-seka/">LinkedIn</a></li>
              <li><a href="https://github.com/franckgseka">GitHub</a></li>
              <li><a href="https://www.instagram.com/franckgseka/">Instagram</a></li>
              <li><a href="https://stackoverflow.com/users/20211580/franck-geoffroy-seka">stackoverflow</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 py-3">
      ...
      <div class="row justify-content-center mt-3">
        ...
        <div class="col-12">
          <p class="text-center mb-0 mt-4">Copyright &copy;2022. In brightest day, in blackest night. By Franck Seka</p>
        </div>
      </div>
    </div>
  </div> <!-- End footer -->
